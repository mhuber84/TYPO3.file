...
/**
 * Test case for class Tx_File_Domain_Model_Category.
 *
 * @version $Id$
 ...
 */
class Tx_File_Domain_Model_CategoryTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	...
	public function setUp() {
		$this->fixture = new Tx_File_Domain_Model_Category();
	}
	 ...
	 * @test
	 */
	public function getParentReturnsInitialValueForTx_File_Domain_Model_Category() { 
		$this->assertEquals(
			NULL,
	 ...
	 * @test
	 */
	public function setParentForTx_File_Domain_Model_CategorySetsParent() { 
		$dummyObject = new Tx_File_Domain_Model_Category();
